...
public class DriveTrain extends SubsystemBase {
  ...
  public void enableBrakes(boolean enabled) {
    ...
    leftMaster.setIdleMode(enabled ? CANSparkMax.IdleMode.kBrake : CANSparkMax.IdleMode.kCoast);
    rightMaster.setIdleMode(enabled ? CANSparkMax.IdleMode.kBrake : CANSparkMax.IdleMode.kCoast);
  }
